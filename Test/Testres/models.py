...
class Evaluation(models.Model):
    STUDENT_EVALUATION = 'S'
    TEACHER_EVALUATION = 'T'
    EVALUATION_TYPES = (
        (STUDENT_EVALUATION, '学生自我评价'),
        (TEACHER_EVALUATION, '教师评价'),
    )
    student = models.ForeignKey(Student, on_delete=models.CASCADE, related_name='evaluations')
    subject = models.CharField(max_length = 10, verbose_name= '评价科目')
    evaluator_type = models.CharField(max_length=1, choices=EVALUATION_TYPES, verbose_name='评价类型')
